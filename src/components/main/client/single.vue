                            ...
                            <div class="user-bg"> <img width="100%" alt="user" src="static/plugins/images/large/img1.jpg">
                                <div class="overlay-box">
                                    <div class="user-content">
                                        ...
                                        <h4 class="text-white">{{ clientStore.client.username }}</h4>
                                        <h5 class="text-white">{{ clientStore.client.email }}</h5>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="tab-pane" id="profile">
                                    <div class="row">
                                        <div class="col-md-3 col-xs-6 b-r">
                                            ...
                                            <br>
                                            <p class="text-muted">{{ clientStore.client.username }}</p>
                                        </div>
                                        <div class="col-md-3 col-xs-6 b-r">
                                            <strong>Mobile</strong>
                                            <br>
                                            <p class="text-muted">{{ clientStore.client.mobile }}</p>
                                        </div>
                                        <div class="col-md-3 col-xs-6 b-r">
                                            <strong>Email</strong>
                                            <br>
                                            <p class="text-muted">{{ clientStore.client.email }}</p>
                                        </div>
                                        <div class="col-md-3 col-xs-6">
                                            <strong>Location</strong>
                                            <br>
                                            <p class="text-muted">{{ clientStore.client.address }}</p>
                                        </div>
                                    </div>
                                    <hr>
                                ...
                                <div class="tab-pane" id="settings">
                                    <form class="form-horizontal form-material">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" :placeholder="clientStore.client.username" class="form-control form-control-line" :value="clientStore.client.username">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" :placeholder="clientStore.client.school" class="form-control form-control-line" :value="clientStore.client.school">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="email" :placeholder="clientStore.client.email" :value="clientStore.client.email" class="form-control form-control-line" name="example-email" id="example-email">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" :placeholder="clientStore.client.mobile" :value="clientStore.client.mobile" class="form-control form-control-line">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-12">Address</label>
                                            <div class="col-md-12">
                                                <textarea rows="5" class="form-control form-control-line">{{ clientStore.client.address }}</textarea>
                                            </div>
                                        </div>
                                        <!-- <div class="form-group">
...
export default {
    ...
    computed: {
        ...mapState({
            clientStore : state => state.clientStore
        })
    },
    ...
    created()
    {
        ...
        axios.get(apiDomain+'manage/getClient/'+userId, {headers: getHeaderMain() })
        .then(res => {
            if(res.data.status == 1){
                this.$store.dispatch('setClientObject', res.data.single);
                document.title = res.data.single.school;
            }
        }).catch(error => {
            console.log(error);
        });
