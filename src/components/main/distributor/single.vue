                            ...
                            <div class="user-bg"> <img width="100%" alt="user" src="static/plugins/images/large/img1.jpg">
                                <div class="overlay-box">
                                    <div class="user-content">
                                        <a href="javascript:void(0)"><img src="static/plugins/images/users/7.jpg" class="thumb-lg img-circle" alt="img"></a>
                                        <h4 class="text-white">{{ distributorStore.distributor.username }}</h4>
                                        <h5 class="text-white">{{ distributorStore.distributor.email }}</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="user-btm-box">
                                <div class="col-md-4 col-sm-4 text-center">
                                    <p class="text-purple">Retailers</p>
                                    <h1>258</h1>
                                </div>
                                <div class="col-md-4 col-sm-4 text-center">
                                    <p class="text-blue">Repsonsive</p>
                                    <h1>125</h1>
                                </div>
                                <div class="col-md-4 col-sm-4 text-center">
                                    <p class="text-danger">Schools</p>
                                    <h1>556</h1>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="white-box">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="home">
                                    <div class="steamline">
                                        <div class="sl-item">
                                            <div class="sl-left"> <img src="static/plugins/images/users/genu.jpg" alt="user" class="img-circle" /> </div>
                                            <div class="sl-right">
                                                <div class="m-l-40">
                                                    <a href="#" class="text-info">John Doe</a> <span class="sl-date">5 minutes ago</span>
                                                    <p>assign a new task <a href="#"> Design weblayout</a></p>
                                                    <div class="m-t-20 row"></div>
                                                </div>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="sl-item">
                                            <div class="sl-left"> <img src="static/plugins/images/users/sonu.jpg" alt="user" class="img-circle" /> </div>
                                            <div class="sl-right">
                                        ...
                                        <hr>
                                        <div class="sl-item">
                                            <div class="sl-left"> <img src="static/plugins/images/users/ritesh.jpg" alt="user" class="img-circle" /> </div>
                                            <div class="sl-right">
                                                <div class="m-l-40"><a href="#" class="text-info">John Doe</a> <span class="sl-date">5 minutes ago</span>
                                        ...
                                        <hr>
                                        <div class="sl-item">
                                            <div class="sl-left"> <img src="static/plugins/images/users/govinda.jpg" alt="user" class="img-circle" /> </div>
                                            <div class="sl-right">
                                                <div class="m-l-40"><a href="#" class="text-info">John Doe</a> <span class="sl-date">5 minutes ago</span>
                                                    <p>assign a new task <a href="#"> Design weblayout</a></p>
                                                </div>
                                ...
                                <div class="tab-pane" id="profile">
                                    <div class="row">
                                        <div class="col-md-3 col-xs-6 b-r"> <strong>Full Name</strong>
                                            <br>
                                            <p class="text-muted">{{ distributorStore.distributor.username }}</p>
                                        </div>
                                        <div class="col-md-3 col-xs-6 b-r"> <strong>Mobile</strong>
                                            <br>
                                            <p class="text-muted">{{ distributorStore.distributor.mobile }}</p>
                                        </div>
                                        <div class="col-md-3 col-xs-6 b-r"> <strong>Email</strong>
                                            <br>
                                            <p class="text-muted">{{ distributorStore.distributor.email }}</p>
                                        </div>
                                        <div class="col-md-3 col-xs-6"> <strong>Location</strong>
                                            <br>
                                            <p class="text-muted">{{ distributorStore.distributor.address }}</p>
                                        </div>
                                    </div>
                                    <hr>
                                ...
                                <div class="tab-pane" id="settings">
                                    <form class="form-horizontal form-material">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" :placeholder="distributorStore.distributor.username" class="form-control form-control-line" :value="distributorStore.distributor.username">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="example-email" class="col-md-12">Email</label>
                                            <div class="col-md-12">
                                                <input type="email" :placeholder="distributorStore.distributor.email" :value="distributorStore.distributor.email" class="form-control form-control-line" name="example-email" id="example-email">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" :placeholder="distributorStore.distributor.mobile" :value="distributorStore.distributor.mobile" class="form-control form-control-line">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-12">Address</label>
                                            <div class="col-md-12">
                                                <textarea rows="5" class="form-control form-control-line">{{ distributorStore.distributor.address }}</textarea>
                                            </div>
                                        </div>
                                        <!-- <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                ...
                                                <button class="btn btn-danger">Deactivate Retailer</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
...
export default {
    ...
    computed: {
        ...mapState({
            distributorStore : state => state.distributorStore
        })
    },
    ...
    created()
    {
        ...
        axios.get(apiDomain+'manage/getDistributor/'+userId, {headers: getHeaderMain() })
        .then(res => {
            if(res.data.status == 1){
                this.$store.dispatch('setDistributorObject', res.data.single);
                document.title = res.data.single.username;
            }
        }).catch(error => {
            console.log(error);
        });
